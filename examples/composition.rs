...
//MIME-Version: 1.0
//From: <my@sender>
//Content-Type: multipart/mixed; boundary="=_^a;;_'1GXeyVU{,E=hsJ$ncAig#ij:!"
//To: <my@recev>
//Subject: Dear randomness
//
//--=_^a;;_'1GXeyVU{,E=hsJ$ncAig#ij:!
//Content-Type: multipart/related; boundary="=_^?R8$y:]3!TBV:NLB/oc:1le#Hy%@ZQ"
//
//--=_^?R8$y:]3!TBV:NLB/oc:1le#Hy%@ZQ
//Content-Type: text/plain;charset=utf8
//Content-Transfer-Encoding: quoted-printable
//
//{=0A  "data": {=0A    "users": [=0A      {=0A        "name": "Goblin the Fir=
//st",=0A        "avatar": "yXiqEmjqJ1@content_id_postfix.is.this",=0A        =
//"signature": null=0A      },=0A      {=0A        "name": "Spider Dog",=0A   =
//"avatar": "RcWf1jKDy8@content_id_postfix.is.this",=0A        "signature=
//": null=0A      }=0A    ]=0A  }=0A}
//--=_^?R8$y:]3!TBV:NLB/oc:1le#Hy%@ZQ
//Content-Type: text/plain;charset=utf8
//Content-Transfer-Encoding: quoted-printable
//Content-Disposition: inline
//Content-ID: <yXiqEmjqJ1@content_id_postfix.is.this>
//
//this should be an image =C2=AF\_(=E3=83=84)_/=C2=AF
//--=_^?R8$y:]3!TBV:NLB/oc:1le#Hy%@ZQ
//Content-Type: text/plain;charset=utf8
//Content-Transfer-Encoding: quoted-printable
//Content-ID: <RcWf1jKDy8@content_id_postfix.is.this>
//Content-Disposition: inline
//
//another image...
//--=_^?R8$y:]3!TBV:NLB/oc:1le#Hy%@ZQ--
